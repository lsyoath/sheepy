...
Dirs='20170912' #20170825 20170912
Rats='A1 A2 A3 P1 P3 P4 P5 R1 R2 R3 R4 R5'  #A1 A2 A3 P1 P2 P3 P4 P5 R1 R2 R3 R4 R5    #A1 A2 A3 P1 P3 P4 P5 R1 R2 R3 R4 R5
na=''
for dir in ${Dirs}
do
  cd ${rtdir}/${dir}
...
#  3dAllineate -prefix All_anat2template -base /home/prot/MouseResting/WJH/atlas/anatmask_origin_rsmp+orig -source All_anat_align+orig  -twopass -cost ls -1Dmatrix_save All_anat_align.aff12.1D
  ...
  #    3dcalc -a ${rtdir}/atlas/anat_brainmask_rsmp.nii -b ${rtdir}/${rat}/${rat}_BOLD1_align+orig -expr 'a*b' -prefix ${rtdir}/${rat}/${rat}_BOLD1_align_mask
    ...
    3dAllineate -master /home/prot/LearningBehavior/20170912/R5/R5_BOLD1_align+orig. -prefix ${rat}_BOLD1_align2 -source ${rat}_BOLD1_align+orig  -1Dmatrix_apply ${rat}_anat1_align2template.1D -final wsinc5
  ...
  #    3dcalc -a ${rtdir}/atlas/anat_brainmask_rsmp.nii -b ${rtdir}/${rat}/${rat}_BOLD2_align+orig -expr 'a*b' -prefix ${rtdir}/${rat}/${rat}_BOLD2_align_mask
    ...
    3dAllineate -master /home/prot/LearningBehavior/20170912/R5/R5_BOLD2_align+orig. -prefix ${rat}_BOLD2_align2 -source ${rat}_BOLD2_align+orig  -1Dmatrix_apply ${rat}_anat2_align2template.1D -final wsinc5
  ###########################################################################################
    cd ${rtdir}/${dir}
  done
done